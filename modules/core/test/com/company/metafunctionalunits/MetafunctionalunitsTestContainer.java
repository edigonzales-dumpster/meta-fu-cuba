package com.company.metafunctionalunits;
...
public class MetafunctionalunitsTestContainer extends TestContainer {

    public MetafunctionalunitsTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/metafunctionalunits/app.properties",
    ...
    public static class Common extends MetafunctionalunitsTestContainer {

        public static final MetafunctionalunitsTestContainer.Common INSTANCE = new MetafunctionalunitsTestContainer.Common();
